...
public class MqttAndroidClient extends BroadcastReceiver implements
	...
	public MqttAndroidClient(Context context, String serverURI,
		...
		// TODO: 2018/5/15 测试完注释掉
		LoggerPrintInstance.init(context);
		myContext = context;
	...
	// TODO: 2018/5/1 old one change here
		...
		if (callback != null) {
			...
			try {
				if (messageAck == Ack.AUTO_ACK) {
					...
					Log.i(LogTagConstant.TAG, "3==MqttAndroidClient messageArrivedAction callback.messageArrived回调给MainActivity：" + message);
