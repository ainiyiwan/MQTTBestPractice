...
class MqttConnection implements MqttCallbackExtended {
	...
	private void deliverBacklog() {
		...
		while (backlog.hasNext()) {
			...
			Log.i(LogTagConstant.TAG, "deliverBacklog 发送客户端未收到的消息：" + msgArrived);
	...
	public void messageArrived(String topic, MqttMessage message)
			throws Exception {
//		LoggerPrintInstance.getLogger().i(LogTagConstant.PRINT_LOG, "1==MqttConnection messageArrive收到消息：" + message.toString());
		Log.i(LogTagConstant.TAG, "1==MqttConnection messageArrive收到消息：" + message.toString());
		service.traceDebug(TAG,
